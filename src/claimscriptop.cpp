...
CClaimScriptUndoAddOp::CClaimScriptUndoAddOp(const COutPoint& point, int nHeight)
    : point(point), nHeight(nHeight)
{
}
...
{
    bool succeed = trieCache.undoAddClaim(name, point, nHeight);
...
{
    bool succeed = trieCache.undoAddSupport(name, point, nHeight);
...
{
    bool succeed = trieCache.spendClaim(name, point, nHeight, nValidHeight);
...
{
    bool succeed = trieCache.spendSupport(name, point, nHeight, nValidHeight);
